...
var $d_Lmain_scala_LocationOptions = new $TypeData().initClass({
  Lmain_scala_LocationOptions: 0
}, false, "main.scala.LocationOptions", {
  Lmain_scala_LocationOptions: 1
...
$c_Lmain_scala_Location.prototype = new $h_O();
$c_Lmain_scala_Location.prototype.constructor = $c_Lmain_scala_Location;
/** @constructor */
function $h_Lmain_scala_Location() {
  /*<skip>*/
}
$h_Lmain_scala_Location.prototype = $c_Lmain_scala_Location.prototype;
$c_Lmain_scala_Location.prototype.init___I__I = (function(x, y) {
  this.x$1 = x;
  this.y$1 = y;
  return this
});
$c_Lmain_scala_Location.prototype.toJSObject__Lmain_scala_LocationOptions = (function() {
  var xv = this.x$1;
  var yv = this.y$1;
  var $this = {};
  $this.x = 0;
...
function $is_Lmain_scala_Location(obj) {
  return (!(!((obj && obj.$classData) && obj.$classData.ancestors.Lmain_scala_Location)))
}
function $as_Lmain_scala_Location(obj) {
  return (($is_Lmain_scala_Location(obj) || (obj === null)) ? obj : $throwClassCastException(obj, "main.scala.Location"))
}
function $isArrayOf_Lmain_scala_Location(obj, depth) {
  return (!(!(((obj && obj.$classData) && (obj.$classData.arrayDepth === depth)) && obj.$classData.arrayBase.ancestors.Lmain_scala_Location)))
}
function $asArrayOf_Lmain_scala_Location(obj, depth) {
  return (($isArrayOf_Lmain_scala_Location(obj, depth) || (obj === null)) ? obj : $throwArrayCastException(obj, "Lmain.scala.Location;", depth))
}
var $d_Lmain_scala_Location = new $TypeData().initClass({
  Lmain_scala_Location: 0
}, false, "main.scala.Location", {
  Lmain_scala_Location: 1,
  O: 1
});
...
/** @constructor */
$e.main.scala.Location = (function(arg$1, arg$2) {
  var $thiz = new $c_Lmain_scala_Location();
  var prep0 = $uI(arg$1);
  var prep1 = $uI(arg$2);
  $c_Lmain_scala_Location.prototype.init___I__I.call($thiz, prep0, prep1);
  return $thiz
});
